...
class MandarinPrimaryAssesmentRecordExport implements FromCollection, WithHeadings, WithStyles, WithEvents, ShouldAutoSize
{
    protected $class;
    protected $subject;
    ...
    public function headings(): array
    {
        return [
            ...
            [
                'No',
                'Name',
                'Understands vocabulary and grammar',
                'Writes characters with correct stroke',
                'Neatness and cleanliness',
                'Correct intonation and pronunciation',
                'Reads fluently',
                'Is able to transfer the words listened into written form',
                'Is able to pronounce word properly'
            ],      // Header tabel
        ];
    }
