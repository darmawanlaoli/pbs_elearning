...
class PePrimaryAssesmentRecordExport implements FromCollection, WithHeadings, WithStyles, WithEvents, ShouldAutoSize
{
    protected $class;
    protected $subject;
    ...
    public function headings(): array
    {
        return [
            ...
            ['No', 'Name', 'Understranding Concept', 'Understands Rules', 'Use Variety of Locomotors Movement'],      // Header tabel
        ];
    }
