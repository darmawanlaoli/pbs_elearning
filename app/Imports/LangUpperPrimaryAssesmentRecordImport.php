...
class LangUpperPrimaryAssesmentRecordImport implements ToModel, WithHeadingRow, WithStartRow, WithEvents
{
    protected $class;
    ...
    public function model(array $row)
    {
        return new PrimaryAssesmentRecordDetails([
            ...
            'lang_neatness_in_writing' => $row['demonstrates_neatness_in_writing'],
