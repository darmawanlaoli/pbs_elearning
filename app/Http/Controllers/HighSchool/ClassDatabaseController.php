...
class ClassDatabaseController extends Controller
{
    public function index()
    {
        ...
        $classes = HsClass::orderBy('class', 'ASC')->get();
        return view('high_school.class_database.index', compact('title', 'path', 'classes'));
    }
