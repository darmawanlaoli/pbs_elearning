...
class SubjectDatabaseController extends Controller
{
    public function index()
    {
        ...
        $subjects = HsSubject::orderBy('subject', 'ASC')->get();
        return view('high_school.subject_database.index', compact('title', 'path', 'subjects'));
    }
