...
class LessonMaterialController extends Controller
{
    public function index()
    {
        ...
        $lessonplans = DB::table('primary_lesson_materials')
            ->where('teacher', session('name'))
            ->get();
        return view('primaryteacher/lesson_material/index', compact('title', 'path', 'lessonplans'));
    }
    ...
    public function create(){
        ...
        return view('primaryteacher/lesson_material/create', compact('title', 'path', 'subjects'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('primary_teacher.lesson_material')->with('success', 'Lesson material successfully saved.');
    }
    ...
    {
        $lessonMaterial = PrimaryLessonMaterial::findOrFail($id);
        $lessonMaterial->delete();

        return redirect()->route('primary_teacher.lesson_material')->with(['success' => 'Data has been successfully deleted']);
    }
