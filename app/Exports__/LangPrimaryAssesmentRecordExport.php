...
class LangPrimaryAssesmentRecordExport implements FromCollection, WithHeadings, WithStyles, WithEvents, ShouldAutoSize
{
    protected $class;
    protected $subject;
    ...
    public function headings(): array
    {
        return [
            ...
            ['No', 'Name', 'Understranding Concept', 'Demonstrates neatness in writing', 'Writes with fluency', 'Reads with fluency', 'Reads accurately with understanding', 'Listens with understanding', 'Expresses ideas when speaking'],      // Header tabel
        ];
    }
