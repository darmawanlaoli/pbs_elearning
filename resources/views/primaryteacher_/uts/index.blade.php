...
<div class="container-fluid">
    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('primary_teacher.uts.create') }}" class="btn btn-primary mb-2"><i
                                ...
                                <td class="d-flex">
                                    <div class="d-flex justify-content-center gap-1 flex-wrap">
                                        <form id="deleteForm-{{ $lesson->id }}"
                                            action="{{ route('primary_teacher.uts.destroy', $lesson->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        <a tabindex="0" data-bs-toggle="tooltip" title="Detail"
                                            ...
                                            href="{{ route('primary_teacher.uts.detail', $lesson->id) }}"><i
                                                class="ti ti-eye"></i></a>
                                    </div>
                                </td>
                            <tr>
