                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 150px">
                                        <input type="number" class="form-control text-center pe_understand_rules-input"
                                            name="assesments[{{ $assesment->id }}][pe_understand_rules]"
                                            value="{{ $assesment->pe_understand_rules }}">
                                    </td>

                                    <td class="text-center" style="width: 150px">
                                        <input type="number"
                                            class="form-control text-center pe_locomotors_movement-input"
                                            name="assesments[{{ $assesment->id }}][pe_locomotors_movement]"
                                            value="{{ $assesment->pe_locomotors_movement }}">
                                    </td>
