    ...
    <table>
        ...
        <tbody>
            ...
            <tr data-student-id="{{ $ass->id }}">
                ...
                {{-- Chapter Test --}}
                <td>
                    <input type="number" value="{{ $ass->ct1 ?? '' }}" class="score-input ct-input"
                        name="students[{{ $ass->id }}][ct1]" min="0" max="100" step="0.01">
                </td>
                <td>
                ...
                {{-- HW --}}
                <td>
                    <input type="number" value="{{ $ass->hw1 ?? '' }}" class="score-input ku-input" name="students[{{ $ass->id }}][hw1]"
                        min="0" max="100" step="0.01">
                </td>

                <td>
                    <input type="number" value="{{ $ass->hw2 ?? '' }}" class="score-input ku-input" name="students[{{ $ass->id }}][hw2]"
                        min="0" max="100" step="0.01">
                </td>

                <td>
                    <input type="number" value="{{ $ass->hw_avg ?? '' }}" class="score-input avg-input"
