    ...
    <div class="container-fluid">
        ...
        <div class="widget-content searchable-container list">
            ...
            <div class="card mb-3 col-md-8 col-lg-8 mx-auto">
                <div class="card-header font-weight-bold">Print Rapor {{ $academic_year->term }}</div>
                <div class="card-body">
                        ...
                        <div class="page">
                            ...
                            <table style="font-weight: bold">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanIndonesia->mean_indo_concept ?? 0, 2) }}
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanIndonesia->mean_indo_neatness_in_writing ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr class="text-center">
                                    <td colspan="2">
                                        @if ($indo_lang_neatness_in_writing > 80)
                                            M
                                        @elseif ($indo_lang_neatness_in_writing > 60)
                                            D
                                        @else
                                            B
                                        @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanIndonesia->mean_indo_lang_writes_with_fluency ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr class="text-center">
                                    <td colspan="2">
                                        @if ($indo_lang_writes_with_fluency > 80)
                                            M
                                        @elseif ($indo_lang_writes_with_fluency > 60)
                                            D
                                        @else
                                            B
                                        @endif
                                ...
                                @if ($grade == 'P1' || $grade == 'P2' || $grade == 'P3')
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{ number_format($meanIndonesia->mean_indo_reads_fluency ?? 0, 2) }}
                                        </td>
                                    </tr>
                                    <tr class="text-center">
                                        <td colspan="2">
                                            @if ($indo_lang_reads_fluency > 80)
                                                M
                                            @elseif ($indo_lang_reads_fluency > 60)
                                                D
                                            @else
                                                B
                                            @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanIndonesia->mean_indo_reads_accurately ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr class="text-center">
                                    <td colspan="2">
                                        @if ($indo_lang_reads_accurately > 80)
                                            M
                                        @elseif ($indo_lang_reads_accurately > 60)
                                            D
                                        @else
                                            B
                                        @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanIndonesia->mean_indo_listen_with_understanding ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr class="text-center">
                                    <td colspan="2">
                                        @if ($indo_lang_listen_with_understanding > 80)
                                            M
                                        @elseif ($indo_lang_listen_with_understanding > 60)
                                            D
                                        @else
                                            B
                                        @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanIndonesia->mean_indo_expresses_ideas ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr class="text-center">
                                    <td colspan="2">
                                        @if ($indo_lang_expresses_ideas > 80)
                                            M
                                        @elseif ($indo_lang_expresses_ideas > 60)
                                            D
                                        @else
                                            B
                                        @endif
                            ...
                            <table class="mt-1" style="font-weight: bold">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanEnglish->mean_english_concept ?? 0, 2) }}
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanEnglish->mean_lang_neatness_in_writing ?? 0, 2) }}
                                    </td>
                                    </td>
                                </tr>
                                <tr class="text-center">
                                    <td colspan="2">
                                        @if ($eng_lang_neatness_in_writing > 80)
                                            M
                                        @elseif ($eng_lang_neatness_in_writing > 60)
                                            D
                                        @else
                                            B
                                        @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanEnglish->mean_lang_writes_with_fluency ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr class="text-center">
                                    <td colspan="2">
                                        @if ($eng_lang_writes_with_fluency > 80)
                                            M
                                        @elseif ($eng_lang_writes_with_fluency > 60)
                                            D
                                        @else
                                            B
                                        @endif
                                ...
                                @if ($grade == 'P1' || $grade == 'P2' || $grade == 'P3')
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{ number_format($meanEnglish->mean_lang_reads_fluency ?? 0, 2) }}
                                        </td>
                                    </tr>
                                    <tr class="text-center">
                                        <td colspan="2">
                                            @if ($eng_lang_reads_fluency > 80)
                                                M
                                            @elseif ($eng_lang_reads_fluency > 60)
                                                D
                                            @else
                                                B
                                            @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanEnglish->mean_lang_reads_accurately ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr class="text-center">
                                    <td colspan="2">
                                        @if ($eng_lang_reads_accurately > 80)
                                            M
                                        @elseif ($eng_lang_reads_accurately > 60)
                                            D
                                        @else
                                            B
                                        @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanEnglish->mean_lang_listen_with_understanding ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr class="text-center">
                                    <td colspan="2">
                                        @if ($eng_lang_listen_with_understanding > 80)
                                            M
                                        @elseif ($eng_lang_listen_with_understanding > 60)
                                            D
                                        @else
                                            B
                                        @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanEnglish->mean_lang_expresses_ideas ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr class="text-center">
                                    <td colspan="2">
                                        @if ($eng_lang_expresses_ideas > 80)
                                            M
                                        @elseif ($eng_lang_expresses_ideas > 60)
                                            D
                                        @else
                                            B
                                        @endif
                            ...
                            @if ($grade == 'P3' || $grade == 'P4' || $grade == 'P5' || $grade == 'P6')
                                ...
                                <table class="mt-1" style="font-weight: bold">
                                    <tr>
                                        <th style="width: 450px" rowspan="2" class="subject header">INFORMATION AND
                                            COMMUNICATION
                                            <br>
                                            TECHNOLOGY
                                        </th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{ number_format($meanIct->mean_ict_concept ?? 0, 2) }}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{ number_format($meanIct->mean_ict_demonstrate ?? 0, 2) }}</td>
                                    </tr>

                                    <tr class="text-center">
                                        <td colspan="2">
                                            @if ($ict_demonstrate > 80)
                                                M
                                            @elseif ($ict_demonstrate > 60)
                                                D
                                            @else
                                                B
                                            @endif
                            ...
                            <div class="footer">
                                <span class="left">{{ 's' . '/' . session('homeroom_class') . '/2025-2026' }}</span>
                        ...
                        <div class="page">
                            ...
                            <table class="mt-2" style="font-weight: bold">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanArt->mean_art_followed_direction ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr class="text-center">
                                    <td colspan="2">
                                        @if ($art_followed_direction > 80)
                                            M
                                        @elseif ($art_followed_direction > 60)
                                            D
                                        @else
                                            B
                                        @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ number_format($meanArt->mean_art_displayed_neat ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr class="text-center">
                                    <td colspan="2">
                                        @if ($art_displayed_neat > 80)
                                            M
                                        @elseif ($art_displayed_neat > 60)
                                            D
                                        @else
                                            B
                                        @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanArt->mean_art_finished_project ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr class="text-center">
                                    <td colspan="2">
                                        @if ($art_finished_project > 80)
                                            M
                                        @elseif ($art_finished_project > 60)
                                            D
                                        @else
                                            B
                                        @endif
                            ...
                            <table class="mt-2" style="font-weight: bold">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanMandarin->mean_mandarin_understands_vocabulary ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr class="text-center">
                                    <td colspan="2">
                                        @if ($mandarin_understands_vocabulary > 80)
                                            M
                                        @elseif ($mandarin_understands_vocabulary > 60)
                                            D
                                        @else
                                            B
                                        @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanMandarin->mean_mandarin_writes_characters ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr class="text-center">
                                    <td colspan="2">
                                        @if ($mandarin_writes_characters > 80)
                                            M
                                        @elseif ($mandarin_writes_characters > 60)
                                            D
                                        @else
                                            B
                                        @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanMandarin->mean_mandarin_neatness ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr class="text-center">
                                    <td colspan="2">
                                        @if ($mandarin_neatness > 80)
                                            M
                                        @elseif ($mandarin_neatness > 60)
                                            D
                                        @else
                                            B
                                        @endif
                                ...
                                <div class="">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{ number_format($meanMandarin->mean_mandarin_correct_intonation ?? 0, 2) }}
                                        </td>
                                    </tr>
                                    <tr class="text-center">
                                        <td colspan="2">
                                            @if ($mandarin_correct_intonation > 80)
                                                M
                                            @elseif ($mandarin_correct_intonation > 60)
                                                D
                                            @else
                                                B
                                            @endif
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{ number_format($meanMandarin->mean_mandarin_reads_fluently ?? 0, 2) }}
                                        </td>
                                    </tr>
                                    <tr class="text-center">
                                        <td colspan="2">
                                            @if ($mandarin_reads_fluently > 80)
                                                M
                                            @elseif ($mandarin_reads_fluently > 60)
                                                D
                                            @else
                                                B
                                            @endif
                                ...
                                <div class="">
                                    ...
                                    <tr class="text-center">
                                        <td colspan="2">
                                            @if ($mandarin_able_to_transfer_the_words > 80)
                                                M
                                            @elseif ($mandarin_able_to_transfer_the_words > 60)
                                                D
                                            @else
                                                B
                                            @endif
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{ number_format($meanMandarin->mean_mandarin_able_to_pronounce ?? 0, 2) }}
                                        </td>
                                    </tr>
                                    <tr class="text-center">
                                        <td colspan="2">
                                            @if ($mandarin_able_to_pronounce > 80)
                                                M
                                            @elseif ($mandarin_able_to_pronounce > 60)
                                                D
                                            @else
                                                B
                                            @endif
                            ...
                            @if ($grade == 'P3' || $grade == 'P4' || $grade == 'P5' || $grade == 'P6')
                                ...
                                <table class="mt-2" style="font-weight: bold">
                                    <tr>
                                        <th style="width: 450px" rowspan="2" class="subject header">SCIENCE AND SOCIAL
                                            STUDY</th>
                                        <th colspan="2" class="header text-uppercase">{{ $academic_year->term }}</th>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{ number_format($meanIpas->mean_ipas_concept ?? 0, 2) }}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{ number_format($meanIpas->mean_ipas_demonstrate ?? 0, 2) }}</td>
                                    </tr>

                                    <tr class="text-center">
                                        <td colspan="2">
                                            @if ($ipas_demonstrate > 80)
                                                M
                                            @elseif ($ipas_demonstrate > 60)
                                                D
                                            @else
                                                B
                                            @endif
                            ...
                            <table class="mt-2" style="font-weight: bold">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ number_format($meanMusic->mean_music_concept ?? 0, 2) }}
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($meanMusic->mean_music_demonstrate ?? 0, 2) }}</td>
                                </tr>

                                <tr class="text-center">
                                    <td colspan="2">
                                        @if ($music_demonstrate > 80)
                                            M
                                        @elseif ($music_demonstrate > 60)
                                            D
                                        @else
                                            B
                                        @endif
                        ...
                        <div class="page">
                            ...
                            <table>
                                ...
                                <tr class="text-center" style="font-weight: bolder;">
                                    ...
                                    <th class="text-uppercase">{{ $academic_year->term }}</th>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <ul class="li">
                                            <li>Fulfills responsibilities and commitments within the learning environment
                                            </li>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <ul class="li">
                                            ...
                                            <li>Identifies, gathers, evaluates, and uses information, technology, and
                                                resources
                                ...
                                <tr>
                                    <td colspan="2">
                                        <ul class="li">
                                            <li>Independently monitors, assesses, and revises plans to complete and meet
                                                goals.
                                            </li>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <ul class="li">
                                            ...
                                            <li>Responds positively to the ideas, opinions, values, and traditions of
                                                others.
                                            </li>
                                            ...
                                            <li>Works with others to resolve conflicts and build consensus to achieve group
                                                goals.</li>
                                            <li>Share information, resources, and expertise, and promotes critical thinking
                                                to
                                ...
                                <tr>
                                    <td colspan="2">
                                        <ul class="li">
                                            ...
                                            <li>Demonstrates the capacity for innovation and a willingness to take risks.
                                            </li>
                                            <li>Demonstrates curiosity and interest in learning.</li>
                                            <li>Approaches new tasks with positive attitude.</li>
                                            <li>Recognizes and advocates appropriately for the rights of self and others.
                                            </li>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <ul class="li">
                                            ...
                                            <li>Assesses and reflects critically on own strengths, needs, and interests.
                                            </li>
                        ...
                        <div class="page">
                            ...
                            <table style="margin-bottom: 40px" style="table-layout: fixed; width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if (($reportData?->grade_club1 ?? '') == 'E')
                                            &#10004;
                                        @endif
                                    </td>

                                    <td class="text-center">
                                        @if (($reportData?->grade_club1 ?? '') == 'G')
                                            &#10004;
                                        @endif
                                    </td>

                                    <td class="text-center">
                                        @if (($reportData?->grade_club1 ?? '') == 'S')
                                            &#10004;
                                        @endif
                                    </td>

                                    <td class="text-center">
                                        @if (($reportData?->grade_club1 ?? '') == 'N')
                                            &#10004;
                                        @endif
                                    </td>
                                </tr>
                            ...
                            <div class="row" style="margin-bottom: 40px">
                                <div class="col-md-6">
                                    <table style="text-align: center;">
                                        ...
                                        <tr>
                                            <th>Excused</th>
                                            <th>{{ ($reportData->att_excused ?? 0) == 0 ? '-' : $reportData->att_excused }}
                                            </th>
                                        </tr>

                                        <tr>
                                            <th>Unexcused</th>
                                            <th>{{ ($reportData->att_unexcused ?? 0) == 0 ? '-' : $reportData->att_unexcused }}
                                            </th>
                                        </tr>

                                        <tr>
                                            <th>Tardy</th>
                                            <th>{{ ($reportData->att_tardy ?? 0) == 0 ? '-' : $reportData->att_tardy }}
                                            </th>
                                        </tr>
                                ...
                                <div class="col-md-6">
                                    <table style="table-layout: fixed; width: 100%; text-align: center">
                                        ...
                                        <tr>
                                            ...
                                            <th style="padding-left: 4px">BEGINNING</th>
                                        </tr>
