        ...
        <div class="card card-body">
            <div class="row">
                ...
                <div
                    ...
                    <a href="{{ route('admin_primary.zoom.create') }}" id="btn-add-contact"
                        class="btn btn-info d-flex align-items-center">
                        <i class="ti ti-users text-white me-1 fs-5"></i> Input Link Zoom
                    </a>
                </div>
            </div>
        </div>
                ...
                <table class="table search-table align-middle text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $zoom->zoom_id }}</td>
                            <td>{{ $zoom->passcode }}</td>
                            <td><form id="deleteForm-{{ $zoom->id }}"
                                action="{{ route('admin_primary.zoom.destroy', $zoom->id) }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
