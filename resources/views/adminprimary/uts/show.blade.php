    ...
    <div class="container-print">
        ...
        <table class="table table-bordered mt-4" style="color: #000000">
            <tr style="color: #000000">
                <td class="font-weight-bold border border-dark" colspan="2">Grade:
                    <?= $class ?>
                </td>
                <td class="font-weight-bold border border-dark text-center text-capitalize">Unit to Study -
                    <?= $term ?>
                </td>
            </tr>
            <tr>
                ...
                <th class="text-center border border-dark">Unit to Study</th>
            </tr>

            <?php $no=1; foreach ($uts as $lp) : ?>
            <tr>
