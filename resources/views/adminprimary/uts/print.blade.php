    ...
    <div class="container-print">
        ...
        <table class="table table-bordered mt-4" style="color: #000000">
            <tr style="color: #000000">
                ...
                <td class="font-weight-bold border border-dark text-center text-capitalize">Lesson
                    Plan -
                    <?= $term ?> /
                    <?= $week ?> (
            ...
            <tr>
                ...
                <th class="text-center border border-dark">Activities</th>
            </tr>

            <?php $no=1; foreach ($lessonplan as $lp) : ?>
            <tr>
