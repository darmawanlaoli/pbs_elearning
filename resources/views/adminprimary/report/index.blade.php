    ...
    <div class="widget-content searchable-container list">
            ...
            <div class="card-body">
                ...
                <form action="" method="GET">
                    ...
                    <div class="input-group">
                        <select required name="class" id="classSelect" class="form-control">
                            <option value="">Select Class</option>

                            @foreach ($classes as $class)
                            <option value="{{ $class->homeroom_class }}" {{ request('class')==$class->homeroom_class ?
                                'selected' : ''
                                }}>
                        ...
                        <select required name="student" id="studentSelect" class="form-control">
                            <option value="">Select Student</option>
                            @if(request('class'))
                            @foreach ($students_request as $student)
        ...
        <div class="cardS">
            ...
            <div class="card-bodyS report-container">
                ...
                <div class="page">
                    ...
                    <table class="mt-2" style="font-weight: bold">
                        <tr>
                            ...
                            <th colspan="2" class="header text-uppercase">{{$current_term}}</th>
                        </tr>
                ...
                <div class="page">
                    ...
                    <table>
                        ...
                        <tr class="text-center" style="font-weight: bolder;">
                            ...
                            <th class="text-uppercase">{{$current_term}}</th>
                        </tr>
                ...
                <div class="page">
                    ...
                    <table style="table-layout: fixed; width: 100%;">
                        ...
                        <tr>
                            ...
                            <th style="height: 120px;">29 September 2025</th>
                ...
                @else
                <div class="text-center h5"><i>Please select class and student name</i></div>
                @endif
            </div>
        </div>
    </div>
...
<script>
    ...
    if (className) {
        $.get('/students-by-class/' + className, function (data) {
