                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="width: 150px">
                                    <input type="number" class="form-control text-center demonstrate-input"
                                        name="assesments[{{ $assesment->id }}][demonstrate]"
                                        value="{{ $assesment->demonstrate }}">
                                </td>
                                ...
                                <td class="text-center avg-cell" style="width: 150px">
                                    {{ ($assesment->concept + $assesment->demonstrate) / 2 }}
                                </td>
                            </tr>
                            @empty
                            <tr>
