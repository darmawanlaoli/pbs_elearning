                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 150px" class="text-center" style="width: 150px">
                                        <input type="number"
                                            class="form-control text-center mandarin_understands_vocabulary-input"
                                            name="assesments[{{ $assesment->id }}][mandarin_understands_vocabulary]"
                                            value="{{ $assesment->mandarin_understands_vocabulary }}">
                                    </td>

                                    <td class="text-center" style="width: 150px">
                                        <input type="number"
                                            class="form-control text-center mandarin_writes_characters-input"
                                            name="assesments[{{ $assesment->id }}][mandarin_writes_characters]"
                                            value="{{ $assesment->mandarin_writes_characters }}">
                                    </td>

                                    <td class="text-center" style="width: 150px">
                                        <input type="number" class="form-control text-center mandarin_neatness-input"
                                            name="assesments[{{ $assesment->id }}][mandarin_neatness]"
                                            value="{{ $assesment->mandarin_neatness }}">
                                    </td>

                                    <td class="text-center" style="width: 150px">
                                        <input type="number"
                                            class="form-control text-center mandarin_correct_intonation-input"
                                            name="assesments[{{ $assesment->id }}][mandarin_correct_intonation]"
                                            value="{{ $assesment->mandarin_correct_intonation }}">
                                    </td>

                                    <td class="text-center" style="width: 150px">
                                        <input type="number"
                                            class="form-control text-center mandarin_reads_fluently-input"
                                            name="assesments[{{ $assesment->id }}][mandarin_reads_fluently]"
                                            value="{{ $assesment->mandarin_reads_fluently }}">
                                    </td>

                                    <td class="text-center" style="width: 150px">
                                        <input type="number"
                                            class="form-control text-center mandarin_able_to_transfer_the_words-input"
                                            name="assesments[{{ $assesment->id }}][mandarin_able_to_transfer_the_words]"
                                            value="{{ $assesment->mandarin_able_to_transfer_the_words }}">
                                    </td>

                                    <td class="text-center" style="width: 150px">
                                        <input type="number"
                                            class="form-control text-center mandarin_able_to_pronounce-input"
                                            name="assesments[{{ $assesment->id }}][mandarin_able_to_pronounce]"
                                            value="{{ $assesment->mandarin_able_to_pronounce }}">
                                    </td>
