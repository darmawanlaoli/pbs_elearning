                    ...
                    <table class="table table-striped table-bordered search-table align-middle text-nowrap" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width: 150px" class="text-center">{{ $assesment->art_followed_direction }}
                                </td>
                                <td class="text-center" style="width: 150px">{{ $assesment->art_displayed_neat }}</td>

                                <td class="text-center" style="width: 150px">{{ $assesment->art_finished_project }}</td>
