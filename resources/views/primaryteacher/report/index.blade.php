...
<div class="container-fluid">
    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card mb-3 col-md-8 col-lg-8 mx-auto">
            <div class="card-header font-weight-bold">Print Rapor {{ $academicyears->term}}</div>
            <div class="card-body">
                <p class="text-center">Sebelum print rapor, pastikan sudah membaca <a target="blank" href="https://drive.google.com/file/d/1mNbFX0zcd4cXMEnI-ZrN6w1w0Tw3Wyje/view?usp=sharing">panduan
                        ini</a></p>
                ...
                <div class="page">
                    ...
                    <table>
                        ...
                        <tr class="text-center" style="font-weight: bolder;">
                            ...
                            <th class="text-uppercase">{{ $academicyears->term }}</th>
                        </tr>
