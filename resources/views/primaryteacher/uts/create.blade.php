    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card col-md-8 col-lg-8 mx-auto">
            <div class="card-body">
                ...
                <form action="{{ route('primary_teacher.uts.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-3 position-relative">
                        <label class="control-label col-form-label">Unit to Study</label>
                        <input id="activities" type="hidden"
                            class="form-control @error('activites') is-invalid @enderror" name="uts">
