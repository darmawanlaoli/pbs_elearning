                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center avg-cell" style="width: 150px">
                                        ...
                                        $assesment->lang_writes_with_fluency + $assesment->lang_reads_accurately +
                                        $assesment->lang_expresses_ideas) / 5) }}
                                    </td>
                                </tr>
                                @empty
                                <tr>
...
<script>
    ...
    table.addEventListener("input", function(e) {
        if (e.target.classList.contains("concept-input") ||
            ...
            console.log(concept, lang_neatness_in_writing, lang_writes_with_fluency, lang_reads_accurately, lang_expresses_ideas);
            const total = concept + lang_neatness_in_writing + lang_writes_with_fluency + lang_reads_accurately + lang_expresses_ideas;
