                        ...
                        <table style="font-size: 12px"
                            ...
                            <thead class="header-item text-center">
                                <tr class="text-uppercase">
                                    ...
                                    <th>Expresses ideas <br> clearly in <br> writing</th>
                                    @else
                                    <th>Demonstrates <br> neatness in <br> writing</th>
                                    @endif

                                    <th>Writes with <br> fluency</th>
                                    <th>Reads with <br> fluency</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 150px">
                                        <input type="number" class="form-control text-center lang_reads_fluency-input"
                                            name="assesments[{{ $assesment->id }}][lang_reads_fluency]"
                                            value="{{ $assesment->lang_reads_fluency }}">
                                    </td>
                                    ...
                                    <td class="text-center total-cell" style="width: 150px">
                                        ...
                                        $assesment->lang_expresses_ideas + $assesment->lang_reads_fluency +
                                    ...
                                    <td class="text-center avg-cell" style="width: 150px">
                                        ...
                                        $assesment->lang_writes_with_fluency + $assesment->lang_reads_accurately +
                                        $assesment->lang_expresses_ideas + $assesment->lang_reads_fluency +
                                        $assesment->lang_listen_with_understanding) / 7) }}
                                    </td>
                                </tr>
                                @empty
                                <tr>
...
<script>
    ...
    table.addEventListener("input", function(e) {
        if (e.target.classList.contains("concept-input") ||
            ...
            e.target.classList.contains("lang_reads_fluency-input") ||
            ...
            const lang_reads_fluency = parseFloat(row.querySelector(".lang_reads_fluency-input").value) || 0;
            const lang_listen_with_understanding = parseFloat(row.querySelector(".lang_listen_with_understanding-input").value) || 0;

            console.log(concept, lang_neatness_in_writing, lang_writes_with_fluency, lang_reads_accurately, lang_expresses_ideas, lang_reads_fluency, lang_listen_with_understanding);
            const total = concept + lang_neatness_in_writing + lang_writes_with_fluency + lang_reads_accurately + lang_expresses_ideas + lang_reads_fluency + lang_listen_with_understanding;
