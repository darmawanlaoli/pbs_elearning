    ...
    <div class="widget-content searchable-container list">
        <div class="card col-md-8 col-lg-8 mx-auto">
            <div class="card-body">
                ...
                <form action="{{ route('hs_teacher.ct.store') }}" method="POST"
                    ...
                    <div class="mb-3 position-relative">
                        ...
                        <div class="input-group">
                            <select name="class" class="form-control @error('class') is-invalid @enderror">
                                ...
                                <option value="Y8 Integrity">Y8 Integrity</option>
                                <option value="Y8 Honesty">Y8 Honesty</option>
                                <option value="Y9 Courage">Y9 Courage</option>
