    ...
    <div class="widget-content searchable-container list">
        <div class="card col-md-8 col-lg-8 mx-auto">
            <div class="card-body">
                ...
                <form action="{{ route('hs_teacher.assignment.store') }}" method="POST"
                    ...
                    <!-- File Upload -->
                    <div class="mb-3 position-relative" id="uploadGroup">
                        <label class="control-label col-form-label">Upload File</label>
                        <input type="file" name="file_upload" class="form-control @error('file') is-invalid @enderror" />
                        @error('file')
                        <div class="invalid-feedback">{{$message}}</div>
                        @enderror
                    </div>
                    ...
                    <!-- Radio Button -->
                    <div class="mb-3 position-relative">
                        <label class="control-label col-form-label">Type of student's response</label>
