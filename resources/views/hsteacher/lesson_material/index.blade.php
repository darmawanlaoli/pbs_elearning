...
<div class="container-fluid">
    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('hs_teacher.lesson_material.create') }}" class="btn btn-primary mb-2"><i
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a tabindex="0" data-bs-toggle="tooltip" title="Download"
                                        ...
                                        href="{{'/lesson_material/'.$lesson->file}}"><i class="ti ti-arrow-down"></i>
                                        Download</a>
                                ...
                                <td class="d-flex">
                                    <div class="d-flex justify-content-center gap-1 flex-wrap">
                                        <form id="deleteForm-{{ $lesson->id }}"
                                            action="{{ route('hs_teacher.lesson_material.destroy', $lesson->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
