                ...
                <div class="page">
                    ...
                    <table class="cover-table" style="margin-top: 100px; width: 100%; text-align: center;">
                        <tr>
                            ...
                            <td style="width: 50%">
                                <p style="margin-bottom: 100px;">Bekasi, {{ date('d F Y', strtotime($report->first_day_of_school)) }}</p>
                ...
                <div class="page">
                    ...
                    <table class="mt-2" style="font-weight: bold">
                        <tr>
                            ...
                            <th colspan="2" class="header text-uppercase">{{ 'Term 1' }}</th>
                        </tr>
                    ...
                    <div class="footer">
                        <span class="left">{{ 'Nama Siswa'.'/'.session('homeroom_class').'/'.'2026/2027'
                            }}</span>
                ...
                <div class="page">
                    ...
                    <table>
                        ...
                        <tr class="text-center" style="font-weight: bolder;">
                            ...
                            <th class="text-uppercase">{{ 'Term 1' }}</th>
                        </tr>
