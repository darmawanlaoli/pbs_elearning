...
<div class="container-fluid">
    ...
    <form action="{{ route('kindergarten.report_data.update', $reportData->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-6">
                    ...
                    <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="assessment_date" name="academic_year"
                                    value="{{ $reportData->academic_year }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="assessment_score" class="form-label">Term</label>
                                <input type="text" class="form-control" value="{{ $reportData->term }}" id="assessment_score"
                                    name="term" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Report Card Distribution</label>
                                <input type="date" class="form-control" value="{{ $reportData->distribution_date }}" name="distribution_date" required>
                            </div>
